...
if [ "$BUILD_TYPE" == "default" ]; then
    ...
    cp bindings/jni/android/joex-android.jar joex-android-0.1.0.jar
    export JOEX_DEPLOYMENT=joex-android-0.1.0.jar
else
    export JOEX_DEPLOYMENT=""
fi
